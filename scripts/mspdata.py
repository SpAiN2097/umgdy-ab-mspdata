...
for i in range(len(outLayers)):
    ...
    arcpy.AddField_management(outputGDB + "\\" + outLayers[i],"seaUse","TEXT")
    arcpy.AddField_management(outputGDB + "\\" + outLayers[i],"useType","TEXT")
    arcpy.AddField_management(outputGDB + "\\" + outLayers[i],"useDsc","TEXT")
    arcpy.AddField_management(outputGDB + "\\" + outLayers[i],"srcLayer","TEXT")
    arcpy.AddField_management(outputGDB + "\\" + outLayers[i],"srcPath","TEXT")

arcpy.Append_management(pointLayers,outputGDB + "\\" + outputName + "_point",schema_type="NO_TEST",field_mapping="",subtype="")
arcpy.Append_management(polygonLayers,outputGDB + "\\" + outputName + "_polygon",schema_type="NO_TEST",field_mapping="",subtype="")
arcpy.Append_management(polylineLayers,outputGDB + "\\" + outputName + "_polyline",schema_type="NO_TEST",field_mapping="",subtype="")
